...
const features = [
  {
    ...
    body: "Type, talk or forward. Nook understands messy thoughts — no forms, no lists.",
  },
  {
    emoji: "✅",
    title: "It gets things done",
    body: "Nook tracks, follows up and moves each thing towards completion.",
  },
  {
    emoji: "🧭",
    title: "Smarter decisions",
    body: "Nook researches complete options and recommends the best fit for you.",
  },
  {
    emoji: "💷",
...
const benefits = [
  { title: "Less to think about", body: "Nook remembers and keeps you on track." },
      ...
      <main id="main">
        ...
        <section className="container-wide pt-8 pb-12 text-center sm:pt-16">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-ink-soft">
            Nook is a calm, personal home for everyday life. Inside, Nook remembers what matters,
